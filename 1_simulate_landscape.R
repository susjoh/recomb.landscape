...
simPopulationLandscape <- function(
  map.dist,
  maf.info,
  n.found.hap,  # Number of founder haplotypes generated
  n.loci,       # Number of loci underlying the trait
  n.f,          # Number of females
  n.m,          # Number of males
  f.RS,         # Number of offspring per female
  f.RS.Pr,      # Probability of number of offspring per female.
  sel.thresh.f, # Selection threshold
  sel.thresh.m, # Selection threshold
  prdm9.found.maf, # Starting freq of PRDM9
  n.generations, 
  n.iterations, 
  return.haplos = FALSE,
  verbose = TRUE){
